...
! function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = g, e.getIn = _, e.set = y, e.setIn = m, e.update = I, e.updateIn = b, e.merge = T, e.mergeDeep = O, e.mergeIn = S, e.omit = w, e.addDefaults = A;
    /*!
     * Timm
     *
    ...
    t.exports = function(t, e, n, v, h, E, g) {
        ...
        if (x && (m = f(x.call(new t))) !== Object.prototype && m.next && (s(m, b, !0), r || "function" == typeof m[l] || a(m, l, p)), T && w && "values" !== w.name && (O = !0, A = function() {
                return w.call(this)
            }), r && !g || !d && !O && S[l] || a(S, l, A), u[e] = A, u[b] = p, h)
            if (_ = {
                    values: T ? A : I("values"),
                    keys: E ? A : I("keys"),
                    entries: R
    ...
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.clearPlugin = e.renderPlugin = e.createPluginInstance = e.getPluginDestination = e.getPluginOrigin = e.getPluginConfig = void 0, e.isPluginType = function(t) {
        return t === u.PLUGIN_LOTTIE
    };
    var a = n(253),
        u = n(75),
        c = n(58),
        s = (0, o.default)({}, u.PLUGIN_LOTTIE, {
    ...
    e.getPluginConfig = f("getConfig"), e.getPluginOrigin = f("getOrigin"), e.getPluginDestination = f("getDestination"), e.createPluginInstance = f("createInstance"), e.renderPlugin = f("render"), e.clearPlugin = f("clear")
}, function(t, e, n) {
    var r = n(129),
        i = n(260)(r);
    t.exports = i
                                    ...
                                    a && t.forEach(function(t, r) {
                                        ...
                                        ! function(t) {
                                            var e = t.store,
                                                ...
                                                b = c.id;
                                            z(E, a) && (b = K(n, b));
                                            var T = v.hasBoundaryNodes && r ? m.getClosestElement(r, R) : null;
    ...
    r.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            // /\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", ""), r = t("<img>").attr("src", "").css({
                marginRight: "8px",
                width: "16px"
    ...
    var r = n(6),
        ...
        z = function(t, e, n) {
            return t === k && z(X, e, n), _(t), e = I(e, !0), _(n), i(G, e) ? (n.enumerable ? (i(t, P) && t[P][e] && (t[P][e] = !1), n = T(n, {
                enumerable: b(0, !1)
            })) : (i(t, P) || x(t, P, b(1, {})), t[P][e] = !0), B(t, e, n)) : x(t, e, n)
        },
        K = function(t, e) {
            _(t);
    ...
    V || (u((N = function() {
        ...
        var t = d(arguments.length > 0 ? arguments[0] : void 0),
            e = function(n) {
                this === k && e.call(X, n), i(this, P) && i(this[P], t) && (this[P][t] = !1), B(this, t, b(1, n))
            };
        return o && H && B(k, t, {
            configurable: !0,
            set: e
        ...
        return this._k
    }), S.f = q, w.f = z, n(92).f = O.f = $, n(31).f = Q, n(54).f = Z, o && !n(28) && u(k, "propertyIsEnumerable", Q, !0), v.f = function(t) {
        return W(p(t))
    }), a(a.G + a.W + a.F * !V, {
        Symbol: N
    });
    ...
    t.exports = function(t, e, n, E, g, _) {
        ...
        if (S && !T) return _ || (_ = new r), y || f(t) ? i(t, e, n, E, g, _) : o(t, e, I, n, E, g, _);
        if (!(n & l)) {
    ...
    t.exports = function(t, e, n, r, b, O, S) {
        switch (n) {
            case I:
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        switch (o) {
            ...
            case y.STYLE_SIZE:
                var u = i(t, g.WIDTH),
                    ...
                    f = void 0,
                    l = void 0;
                return f = a.widthUnit === g.AUTO ? N.test(u) ? parseFloat(u) : parseFloat(n.width) : (0, s.default)(parseFloat(u), parseFloat(n.width)), l = a.heightUnit === g.AUTO ? N.test(c) ? parseFloat(c) : parseFloat(n.height) : (0, s.default)(parseFloat(c), parseFloat(n.height)), {
                    widthValue: f,
                    heightValue: l
                };
            case y.STYLE_BACKGROUND_COLOR:
        ...
        switch (i) {
            ...
            case y.STYLE_SIZE:
                ...
                if (p === g.AUTO) {
                    var b = s(e, g.WIDTH);
                    f(e, g.WIDTH, ""), _ = l(e, "offsetWidth"), f(e, g.WIDTH, b)
                }
                if (v === g.AUTO) {
                    var T = s(e, g.HEIGHT);
                    f(e, g.HEIGHT, ""), I = l(e, "offsetHeight"), f(e, g.HEIGHT, T)
                }
                return {
                    widthValue: _, heightValue: I
                };
            case y.STYLE_BACKGROUND_COLOR:
            case y.STYLE_BORDER:
            case y.STYLE_TEXT_COLOR:
                var O = n.config,
                    ...
                    R = O.aValue;
                return {
                    rValue: S, gValue: w, bValue: A, aValue: R
                };
            case y.STYLE_FILTER:
                    ...
                    switch (u) {
                        ...
                        case y.STYLE_TEXT_COLOR:
                            var _ = T[u],
                                ...
                                O = n.aValue;
                            V(t, _, o), a(t, _, O >= 1 ? "rgb(" + m + "," + I + "," + b + ")" : "rgba(" + m + "," + I + "," + b + "," + O + ")");
                            break;
                        default:
                            var S = c.unit,
                                w = void 0 === S ? "" : S;
    ...
    var b = function(t) {
        ...
        T = Object.freeze((r = {}, (0, u.default)(r, y.STYLE_BACKGROUND_COLOR, g.BACKGROUND_COLOR), (0, u.default)(r, y.STYLE_BORDER, g.BORDER_COLOR), (0, u.default)(r, y.STYLE_TEXT_COLOR, g.COLOR), r)),
        O = Object.freeze((i = {}, (0, u.default)(i, m.TRANSFORM_PREFIXED, g.TRANSFORM), (0, u.default)(i, g.BACKGROUND_COLOR, g.BACKGROUND), (0, u.default)(i, g.OPACITY, g.OPACITY), (0, u.default)(i, g.FILTER, g.FILTER), (0, u.default)(i, g.WIDTH, g.WIDTH), (0, u.default)(i, g.HEIGHT, g.HEIGHT), i)),
        S = {},
        w = 1;
    var A = 1;
    var R = function(t, e) {
    ...
    function B(t) {
        ...
        e.actionItems.forEach(function(t) {
            var e = t.actionTypeId,
                i = t.config,
                o = void 0;
            o = (0, E.isPluginType)(e) ? (0, E.clearPlugin)(e) : W({
                effect: Y,
                actionTypeId: e,
                elementApi: r
            }), L({
    ...
    e.ixSession = function() {
        ...
        switch (e.type) {
            ...
            case d:
                for (var m = e.payload, I = m.width, b = m.mediaQueries, T = b.length, O = null, S = 0; S < T; S++) {
                    var w = b[S],
                        A = w.key,
                        R = w.min,
                        x = w.max;
    ...
    var r = n(2),
        ...
        m = function(t, e) {
            var n = t.position,
                ...
                d = f[r];
            null == d && (l = 1, d = c);
            var h = Math.max(d, 0) || 0,
                E = p(h - n),
                _ = p(n + E * l),
                y = 100 * _;
            if (_ === n && t.current) return t;
            for (var m = void 0, I = void 0, b = void 0, T = void 0, O = 0, S = o.length; O < S; O++) {
                var w = o[O],
                    A = w.keyframe,
                    R = w.actionItems;
                if (0 === O && (m = R[0]), y >= A) {
                    ...
                    var x = o[O + 1],
                        L = x && y !== A;
                    I = L ? x.actionItems[0] : null, L && (b = A / 100, T = (x.keyframe - A) / 100)
                }
            }
            var N = {};
            if (m && !I)
                for (var C = 0, M = a.length; C < M; C++) {
                    ...
                    for (var D = (_ - b) / T, j = m.config.easing, F = v(j, D), G = 0, X = a.length; G < X; G++) {
                        var k = a[G],
                            V = g(s, k, m.config),
                            U = (g(s, k, I.config) - V) * F + V;
                        N[k] = U
                    }
            return (0, i.merge)(t, {
                position: _,
        ...
        I = function(t, e) {
            ...
            if (r && o) {
                ...
                if (s) {
                    var b = m - a,
                        T = _ + y,
                        O = p(Math.min(Math.max(0, b / T), 1));
                    t = (0, i.set)(t, "verboseTimeElapsed", T * O)
                }
                if (I < 0) return t;
    ...
    e.ixInstances = function() {
        ...
        switch (e.type) {
            ...
            case f:
                ...
                return X;
            case l:
                for (var B = t, W = Object.keys(t), Y = W.length, z = 0; z < Y; z++) {
                    var K = W[z],
                        Q = t[K],
                        q = Q.continuous ? m : I;
                    B = (0, i.set)(B, K, q(Q, e))
    ...
    e.default = (r = {}, (0, i.default)(r, A, Et()), (0, i.default)(r, R, gt()), (0, i.default)(r, w, Et()), (0, i.default)(r, S, gt()), (0, i.default)(r, C, Et(!1)), (0, i.default)(r, N, gt(!1)), (0, i.default)(r, x, Et()), (0, i.default)(r, L, gt()), (0, i.default)(r, H, {
        ...
        handler: function(t) {
            ...
            switch (u) {
                case z:
                    O = b ? Math.min(h, window.innerWidth) / window.innerWidth : Math.min(g, window.innerHeight) / window.innerHeight;
                    break;
                case K:
                    var A = st(),
                        R = A.scrollLeft,
                        ...
                        L = A.scrollWidth,
                        N = A.scrollHeight;
                    O = b ? Math.min(R + y, L) / L : Math.min(x + I, N) / N;
                    break;
                case Y:
                default:
                    S = q(o, s);
            ...
            return T && (O > .95 || O < .05) && (O = Math.round(O)), (u !== Y || w || w !== a.elementHovered) && (O = f ? 1 - O : O, e.dispatch((0, d.parameterChanged)(S, O))), {
                elementHovered: w,
                clientX: h,
                clientY: g,
                pageX: y,
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function y(e, n) {
            ...
            o.handler = null, o.redirect = r.attr("data-redirect"), g.test(c) ? o.handler = O : c || (i ? o.handler = T : _())
        }
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function b(n, i) {
            ...
            }(c), c.el.off(v), c.button.off(v), c.menu.off(v), S(c), a ? (O(c), c.el.on("setting" + v, function(t) {
                return function(n, r) {
                    r = r || {};
                    var i = f.width();
...
Webflow.require('ix2').init({
    "events": {
        "e-12": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a535c533f97|3fe97aa9-85d3-4ab1-9686-bcd181f86d22"
            },
            "config": {
                "loop": false,
        ...
        "e-14": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a535c533f97|6d86ef13-e36c-5d79-c04a-7983cb46f7ca"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-16": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a535c533f97|691328f5-1266-c3a8-5ea2-ecef58139232"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-24": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a535c533f97|aabd1c98-7ca6-c730-5dfd-40a06e26921d"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-26": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a535c533f97|aabd1c98-7ca6-c730-5dfd-40a06e26921f"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-28": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a535c533f97|aabd1c98-7ca6-c730-5dfd-40a06e269221"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-30": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a535c533f97|aabd1c98-7ca6-c730-5dfd-40a06e26921a"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-32": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a57ef533f9b|7b317940-c67b-22b6-31ee-09729c6a06e9"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-34": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a57ef533f9b|7b317940-c67b-22b6-31ee-09729c6a06ec"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-36": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a57ef533f9b|7b317940-c67b-22b6-31ee-09729c6a06ee"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-38": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cfd93a271000a57ef533f9b|7b317940-c67b-22b6-31ee-09729c6a06f0"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
    ...
    "actionLists": {
        ...
        "a-18": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "5cfd93a271000a535c533f97|36d34d40-35ce-af67-721c-9542312a97be"
                        },
                        "value": 0,
                        "unit": ""
                    }
            ...
            "createdOn": 1560450083602,
            "useFirstGroupAsInitialState": true
        },
        "a-19": {
            "id": "a-19",
            "title": "DEWSCRIPTION HIDE",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-19-n",
                    "actionTypeId": "STYLE_OPACITY",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "5cfd93a271000a57ef533f9b|b186ff9b-9ddd-a754-f8e1-f49de5e18671"
                        },
                        "rValue": 0,
                        "gValue": 0,
                        "bValue": 0,
